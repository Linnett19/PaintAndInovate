...
public class RoboCreeperModel<T extends RoboCreeperEntity> extends HierarchicalModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("paint_and_inovate", "robo-creeper"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 49).addBox(-4.0F, -4.5F, 0.0F, 8.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -11.5F, -2.0F));
        ...
        PartDefinition body2 = body.addOrReplaceChild("body2", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -21.0F, -6.0F, 12.0F, 12.0F, 12.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(24, 40).addBox(-5.0F, -6.0F, -5.0F, 10.0F, 6.0F, 10.0F, new CubeDeformation(0.2F))
                .texOffs(0, 40).addBox(-3.0F, -9.0F, -3.0F, 6.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(24, 44).addBox(-2.0F, -14.0F, 0.0F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 3.0F, 0.0F));
        ...
        PartDefinition leg = body_root.addOrReplaceChild("leg", CubeListBuilder.create().texOffs(48, 0).addBox(-2.0F, -1.0F, -3.0F, 4.0F, 13.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(48, 16).addBox(-2.0F, -1.0F, -3.0F, 4.0F, 13.0F, 3.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(-5.0F, -12.0F, 5.0F, 0.0F, 2.7489F, 0.0F));
        ...
        PartDefinition leg2 = body_root.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(48, 0).mirror().addBox(-2.0F, -1.0F, -3.0F, 4.0F, 13.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(48, 16).mirror().addBox(-2.0F, -1.0F, -3.0F, 4.0F, 13.0F, 3.0F, new CubeDeformation(0.3F)).mirror(false), PartPose.offsetAndRotation(5.0F, -12.0F, 5.0F, 0.0F, -2.7489F, 0.0F));
        ...
        PartDefinition leg3 = body_root.addOrReplaceChild("leg3", CubeListBuilder.create().texOffs(48, 0).mirror().addBox(-2.0F, -1.0F, -3.0F, 4.0F, 13.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(48, 16).mirror().addBox(-2.0F, -1.0F, -3.0F, 4.0F, 13.0F, 3.0F, new CubeDeformation(0.3F)).mirror(false), PartPose.offsetAndRotation(-5.0F, -12.0F, -5.0F, 0.0F, 0.7854F, 0.0F));
        ...
        PartDefinition leg4 = body_root.addOrReplaceChild("leg4", CubeListBuilder.create().texOffs(48, 0).addBox(-2.0F, -1.0F, -3.0F, 4.0F, 13.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(48, 16).addBox(-2.0F, -1.0F, -3.0F, 4.0F, 13.0F, 3.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(5.0F, -12.0F, -5.0F, 0.0F, -0.7854F, 0.0F));
    ...
    public void setupAnim(RoboCreeperEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animate(entity.idleAnimation, RoboCreeperAnimations.IDEL, ageInTicks, 1f);

        this.animate(entity.boomAnimation, RoboCreeperAnimations.BOOM, ageInTicks, 2f);
    }
